...
type AppConfig struct {
	...
	Db              Postgres
	AuthorizeClient AuthorizeClient `required:"true" envconfig:"AUTHORIZE_CLIENT_PATH"`
}

type AuthorizeClient struct {
	Path string `required:"true" envconfig:"AUTHORIZE_CLIENT_PATH"`
	Key  string `envconfig:"AUTHORIZE_CLIENT_KEY"`
}
...
func GetAuthorizeClient() AuthorizeClient {
	return appConfig.AuthorizeClient
}
